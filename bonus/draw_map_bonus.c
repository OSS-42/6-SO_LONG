...
/*   Updated: 2022/07/29 11:55:16 by ewurstei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long_bonus.h"

static void	middle_line_images(t_data *img)
{
	...
	if (img->map[img->lvl1->x][img->lvl1->y] == 'C')
		mlx_put_image_to_window(img->mlx, img->mlx_win,
			img->lvl1->collect, img->lvl1->y * 64, img->lvl1->img_y);
...
void	draw_map(t_data *img)
{
	...
	convert_data(img, 2, img->collect);
	img->lvl1->x = 0;
	img->lvl1->img_x = 0;
	img->lvl1->img_y = 50;
	top_line(img);
