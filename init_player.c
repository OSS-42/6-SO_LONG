...
/*   Updated: 2022/07/29 11:09:25 by ewurstei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_player(t_data *img)
{
	...
	img->player->p_right = mlx_xpm_file_to_image(img->mlx, "assets/perso_right.xpm",
			&img_width, &img_height);
	img->player->p_left = mlx_xpm_file_to_image(img->mlx, "assets/perso_left.xpm",
			&img_width, &img_height);
